...
<!-- 
     ...
     Note: this XSLT was from an earlier version of the project from Google Code that 
     ...
     The ontology is licenced under the terms of Creative Commons By 3.0 licence. This is an open licence that allows to use, re-use, and re-distribute its contents subjected only to the requirement of attribution.
